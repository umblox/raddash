...
echo '<p style="font-size: 16px; color: #555;">Silakan isi ulang atau pilih paket yang sesuai dengan saldo anda.</p>';
echo '<a href="/raddash/transactions/topup.php" style="display: inline-block; padding: 10px 20px; color: #fff; background-color: #28a745; text-decoration: none; border-radius: 4px; margin-right: 10px;">Top-Up Saldo</a>';
echo '<a href="/raddash/views/dashboard.php" style="display: inline-block; padding: 10px 20px; color: #fff; background-color: #007bff; text-decoration: none; border-radius: 4px;">Dashboard</a>';
echo '</div>';
